            ...
            <DialogContent className='sm:max-w-[80vw]'>
                <DialogHeader>
                    <div className='flex items-center gap-2 '>
                        <DialogTitle>
                            <Image src='/logo.png' alt='codemate' width={40} height={40}/>
                        </DialogTitle>
                ...
                <MDEditor.Markdown source={answer} style={{backgroundColor: 'transparent', color: 'black', scrollbarWidth: 'none'}} className='max-w-[70vw] !h-full max-h-[40vh] overflow-scroll'/>
