...
const CreatePage = () => {
    ...
    const hasEnoughtCredits = checkCredits?.data?.userCredits ? checkCredits.data.fileCount <= checkCredits.data.userCredits : true
  return (
    <div className='flex items-center gap-12 h-full justify-center'>
        <img src='/computer.png' className='h-56 w-auto'/>
        <div>
            <div>
                ...
                <p className='text-sm text-muted-foreground'>
                    Enter the URL of your repository to link it to CodeMate  
                </p>
            </div>
            ...
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="h-4"></div>
                    <Button type='submit' disabled={createProject.isPending || checkCredits.isPending || !hasEnoughtCredits}>
